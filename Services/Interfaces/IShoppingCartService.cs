...
namespace VideoProjector.Services.Interfaces
{
    ...
    public interface IShoppingCartService
    {
        ...
        Task<GeneralResponse<bool>> AddCart(ShoppingCartDto cartDto);
        ...
        /// <returns>A task that represents the asynchronous operation. The task result contains a ResponseCenter object with a boolean indicating success or failure.</returns>
        Task<GeneralResponse<bool>> AddItemToCart(ShoppingCartItemDto itemDto);
        ...
        Task<GeneralResponse<List<ShoppingCartItemDto>>> GetShoppingCartItems(int shoppingCartId);
        ...
        /// <param name="shoppingCartId">The identifier of the shopping cart.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains a ResponseCenter object with a boolean indicating success or failure.</returns>
        Task<GeneralResponse<bool>> UpdateCartItem(List<ShoppingCartItemDto> itemDto, int shoppingCartId);
        ...
        /// <returns>A task that represents the asynchronous operation. The task result contains a ResponseCenter object with a boolean indicating success or failure.</returns>
        Task<GeneralResponse<bool>> RemoveCartItem(int shoppingCartItemId);
        ...
        /// <param name="shoppingCartId">The identifier of the shopping cart.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains a ResponseCenter object with a boolean indicating success or failure.</returns>
        Task<GeneralResponse<bool>> ValidateCart(int shoppingCartId);
        ...
        GeneralResponse<decimal> GetTotalPriceItems(List<ShoppingCartItemDto> cartItemsDto);
    }
}
